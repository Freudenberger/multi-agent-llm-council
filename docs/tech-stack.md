...
- Start: `npm start`.
- `OPENROUTER_API_KEY` injected from Render dashboard (`sync: false`).
- `LLM_PROVIDER=mock` is the safe default — the app deploys and runs end-to-end without an API key.
